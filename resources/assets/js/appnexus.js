...
var IS_MOBILE = /iPad|iPhone|iPod|android|webOS|Windows Phone/i.test(
  navigator.userAgent
)
...
var getTags = function getTags() {
  ...
  if (tags.length) {
    if (tags_section !== null) {
      ...
      nota_tags = tags.map(function(el) {
          ...
          apntag.onEvent('adAvailable', id, function(adObj) {
            ...
            if (adObj.adType === 'native') {
              ...
              var imgSrc = _nObj$image.url,
                ...
                sponsoredBy =
                  _nObj$sponsoredBy === void 0 ? '' : _nObj$sponsoredBy,
                _nObj$cta = nObj.cta,
                cta = _nObj$cta === void 0 ? 'Leer más' : _nObj$cta,
                _nObj$clickTrackers = nObj.clickTrackers,
                clickTrackers =
                  _nObj$clickTrackers === void 0 ? '' : _nObj$clickTrackers
              var template = '\n                      <a href="'
                .concat(
                  clickUrl,
      ...
      spaces.forEach(function(space) {
        ...
        var target =
          typeof space.target === 'string'
            ? document.querySelector(''.concat(space.target, ' > section'))
            : space.target
