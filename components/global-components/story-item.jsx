...
const classes = {
  ...
  section: 'story-item__section uppercase text-sm text-black md:mb-15',
  date:
    'story-item__date font-thin ml-5 text-xs text-gray-200 md:mt-5 md:ml-0 md:mb-10',
  bottom: 'story-item__bottom flex mt-10',
  left: 'story-item__left flex flex-col justify-between pr-10 ',
  title: `story-item__title block overflow secondary-font text-xl line-h-xs mt-10`,
  subtitle: `story-item__subtitle hidden secondary-font mt-10 mb-20 text-md text-gray-200 line-h-xs md:block`,
