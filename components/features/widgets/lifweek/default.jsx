...
const classes = {
  ...
  profile_detail:
    'lifweek-designers__profile-detail p-0 md:pl-20 mt-30 md:mt-0',
  profile_name: 'lifweek-designers__profile-name mb-15',
  profile_name_blue:
    'lifweek-designers__profile-name_blue inline-block mr-5 text-white',
  profile_bio: 'lifweek-designers__profile-bio',
  profile_divider: 'lifweek-designers__profile-divider mt-30 mb-20',

  list:
    'lifweek-designers__list border-1 border-solid mb-10 pb-20 pt-30 text-center',
  list_title:
    'lifweek-designers__list-title inline-block mb-20 ml-5 mr-5 md:ml-0 md:mr-0 border-b-1 border-solid',
  list_title_bold: 'lifweek-designers__list-title--bold',
  list_content:
    'lifweek-designers__list-content flex flex-row flex-wrap justify-center items-center',
  list_item: 'lifweek-designers__list-item position-relative m-10',
  list_link: 'lifweek-designers__list-link block text-white',
  list_content_name:
    'lifweek-designers__list-content_name position-absolute text-left',
  list_name: 'lifweek-designers__list-name inline-block text-white',
  list_lastname:
    'lifweek-designers__list-lastname w-full inline-block bg-white',
}
...
const LifweekFeat = () => {
  ...
  return (
    <div className={classes.lifweek}>
      <h2 itemProp="name" className={classes.seccion_title}>
        Diseñadores
      </h2>
      ...
      <div className={classes.list}>
        <h3 itemProp="name" className={classes.list_title}>
          Galería de{' '}
          <span className={classes.list_title_bold}>
            Diseñadores &amp; Marcas
          </span>
        </h3>
        <div className={classes.list_content}>
          {Object.keys(participantes).map(key => {
            ...
            const itemUrl = `/lifweek/disenadores/${key}/${
                ...
                <figure>
                  <a
                    ...
                    <figcaption className={classes.list_content_name}>
                      ...
                      <span className={classes.list_lastname}>
                        {itemName[1]}
                      </span>
                    </figcaption>
                  </a>
