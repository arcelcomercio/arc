...
@Consumer
class MinuteByMinuteFeat extends PureComponent {
  constructor(props) {
    super(props)
    this.state = {}
...
MinuteByMinuteFeat.propTypes = {
  customFields,
}

MinuteByMinuteFeat.label = 'Minuto a minuto - Nuevo'
MinuteByMinuteFeat.static = true
export default MinuteByMinuteFeat
