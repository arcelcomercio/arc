  ...
  return (
    <div role="list" className={classes.mostRead}>
      <h4 itemProp="name" className={classes.title}>
        {logoSidebar && metaValue('section_style') !== 'story-v2-standard' && metaValue('section_style') !== 'story-v2-video' && (
          <img className={classes.logo} alt="logo" src={logoSidebar}></img>
        )}
        {(metaValue('section_style') === 'story-v2-standard' || metaValue('section_style') === 'story-v2-video') && (
