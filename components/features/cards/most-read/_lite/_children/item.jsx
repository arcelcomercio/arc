      ...
      <a itemProp="url" href={websiteUrl} className={classes.link}>
        {viewImage && (
          <figure className={classes.figure}>
            <Image
              src={imageUrl}
              width={arcSite === SITE_DEPOR ? 314 : metaValue('section_style') === 'story-v2-standard' ? 85 : metaValue('section_style') === 'story-v2-video' ? 160 : 118}
              height={arcSite === SITE_DEPOR ? 157 : metaValue('section_style') === 'story-v2-standard' ? 85 : metaValue('section_style') === 'story-v2-video' ? 92 : 72}
              alt={title}
              className={classes.img}
              loading="lazy"
            />
            {metaValue('section_style') === 'story-v2-video' ? (<div className={classes.boxTime}><div className={classes.iconPlay}></div><p className={classes.time}>1:30</p></div>): (<MultimediaIcon type={storyType} />)}
          </figure>
        )}
