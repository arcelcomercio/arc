      ...
      <a itemProp="url" href={websiteUrl} className={classes.link}>
        {viewImage && (
          <figure className={classes.figure}>
            <Image
              src={imageUrl}
              width={arcSite === SITE_DEPOR ? 314 : metaValue('section_style') === 'story-v2-standard' ? 85 : 118}
              height={arcSite === SITE_DEPOR ? 157 : metaValue('section_style') === 'story-v2-standard' ? 85 : 72}
              alt={title}
