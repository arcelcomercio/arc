...
const classes = {
  ...
  gradient: 'cinema-card__gradient full-width position-absolute',
  category: 'cinema-card__category uppercase',
  link: 'cinema-card__link',
  figure: 'cinema-card__figure overflow-hidden',
  image: 'full-width full-height object-cover',
  detail: 'cinema-card__detail full-width position-absolute',
  ...
  select: 'cinema-card__select full-width',
