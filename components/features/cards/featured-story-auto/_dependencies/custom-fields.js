...
const customFields = PropTypes.shape({
    section: PropTypes.string.tag({
        ...
        description: 'Si no se coloca la URL de la sección, se renderiza la última historia publicada. Ejemplo: /deporte-total',
    }),
    ...
    storyNumber: PropTypes.number.tag({
        ...
        description: 'Si no se completa el campo, la posición de la historia será 0 (la última historia publicada)',
        group: 'Configuración',
        min: 0,
        defaultValue: 0
    }),
