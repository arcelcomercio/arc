...
import _Markdown from 'react-markdown/with-html'
...
export const ExpansionPanel = styled(_ExpansionPanel)`
  ${({ theme, collapsedColor, expandedColor }) => css`
    &.MuiExpansionPanel-root {
      background-color: ${collapsedColor || theme.palette.primary.light};
    }
    &.Mui-expanded {
      background-color: ${expandedColor || theme.palette.background.paper};
    }
    padding: 0px 10%;
    ${theme.breakpoints.down('xs')} {
      padding: 0px 0px;
