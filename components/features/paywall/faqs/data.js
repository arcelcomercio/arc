...
const FaqECO = [
  {
    ...
    faqs: [
      {
        q: "¿Qué es acceso ilimitado a la web elcomercio.pe en todos tus dispositivos?",
        a: "Es la opción que te ofrece El Comercio para seguir informándote sin límites a través de su página web desde cualquier dispositivo que desees: celular, laptop, desktop o tablet. Este acceso también te permite navegar sin límites desde la app de El Comercio."
      },
      {
        q: "¿Cómo funciona?",
      ...
      {
        q: "Si no adquiero ningún plan digital, ¿puedo seguir navegando en la web de El Comercio?",
        a: "Si has cumplido el número de notas gratuitas mensuales, puedes seguir accediendo a la página principal de la web y/o la app, pero no a las notas y demás contenido. Solo adquiriendo tu suscripción digital puedes seguir navegando sin límites."
      },
      {
        q: "Estoy suscrito a la edición impresa de El Comercio. ¿Debo adquirir el Plan Digital para navegar ilimitadamente en la web / app?",
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Son las ediciones impresas de El Comercio que se encuentran en formato digital (PDF) en la web de Perú Quiosco. Adquiriendo el Plan Digital + Impreso, podrás leer la versión digital desde el dispositivo que quieras."
      },
      {
        q: "¿Cómo funciona el programa de beneficios Club El Comercio?",
        a: "Es el programa de beneficios exclusivo para suscriptores del diario El Comercio, donde accedes a descuentos en restaurantes, entretenimiento y más, las veces que desees con cualquier medio de pago. Ver más en [Club El Comercio](https://clubelcomercio.pe/)"
      },
      {
      ...
      },
      {
        ...
        a: "Puedes realizar el cambio de medio de pago accediendo a tu perfil en www.elcomercio.pe "
      },
      {
        q: "¿Desde cuándo hago uso de los beneficios de Club El Comercio?",
        a: "Podrás hacer uso de los descuentos y promociones de Club El Comercio  al momento de culminar el pago con cualquier medio de pago. Siempre que haya culminado su registro ingresando al link que le llegará por correo electrónico al titular de la suscripción."
      },
      {
        q: "¿Quiénes tienen acceso a las promociones?",
        a: "Todas aquellas personas que se encuentren registradas en la base de suscriptores de El Comercio"
      },
      {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. El proceso de registro es completamente gratuito. Pero recuerda que Registrarte (crear un usuario en la web o app de El Comercio) es distinto a suscribirte al Plan Digital o a alguno de los otros planes. Suscribirte sí implica un pago."
      },
      {
      ...
      },
      {
        ...
        a: "Asegúrate de ingresar la información correctamente en los espacios solicitados del formulario. Si aun así no logras registrarte, contáctanos al (01) 311-5100 o a [suscripciones@comercio.com.pe]"
      },
      {
