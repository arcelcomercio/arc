    ...
    <div className="nav-d__main">
      <nav className="nav-d">
        <div className="nav-d__wrap">
          ...
          <button type="button" className="nav-d__sign">
            <svg
              className="nav-d__sign-svg"
              width="22"
              height="22"
              viewBox="0 0 22 22"
              fill="none"
            ...
            <span className="nav-d__sign-t">Inicia sesión</span>
          </button>
        </div>
      </nav>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `${menuScript}${searchScript}${signwallScript(arcSite, env)}`,
        }}
      />
    </div>
  )
