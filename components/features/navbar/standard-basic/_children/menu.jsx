...
const NavbarChildMenu = ({ sections }) => {
  ...
  const menuScript = '"use strict";document.addEventListener("DOMContentLoaded",function(){/iPad|iPhone|iPod|android|webOS|Windows Phone/i.test(window.navigator.userAgent)?document.querySelector(".nav-sidebar__content").classList.add("w-full"):document.querySelector(".nav-sidebar__content").classList.add("w-desktop"),document.querySelector(".nav__btn--section").addEventListener("click",function(){document.querySelector(".nav-sidebar").classList.contains("active")?(document.querySelector(".nav-sidebar").classList.remove("active"),document.querySelector(".nav-sidebar__content").classList.remove("active")):(document.querySelector(".nav-sidebar").classList.add("active"),document.querySelector(".nav-sidebar__content").classList.add("active")),null===document.querySelector(".nav-sidebar__item")&&["<<sections>>"].forEach(function(e){var t=e.children,a=void 0===t?[]:t,n=e.name,i=void 0===n?"":n,r=e._id,d=void 0===r?"":r,c=e.display_name,o=void 0===c?"":c,s=e.url,l=void 0===s?"":s,u="root-".concat(i||o).toLowerCase(),m=document.createElement("li");m.className="nav-sidebar__item position-relative flex justify-between items-center flex-wrap";var v=document.createElement("a");if(v.className="nav-sidebar__link block p-15 pl-25 text-md text-white",v.href=l||d||"/",v.innerHTML=i||o,m.append(v),a&&a.length>0){var b=document.createElement("input");b.className="nav-sidebar__menu-arrow hidden",b.setAttribute("type","checkbox"),b.setAttribute("id",u),b.setAttribute("name","checkbox-submenu");var p=document.createElement("label");p.htmlFor=u,p.className="nav-sidebar__parent-item pl-25 pt-10 pr-20 pb-10 position-absolute right-0";var _=document.createElement("ul");_.className="nav-sidebar__container-submenu w-full overflow-hidden deep-0".concat(u),m.append(b,p,_),a.forEach(function(e){var t=e.name,a=void 0===t?"":t,n=e._id,i=void 0===n?"":n,r=e.display_name,d=void 0===r?"":r,c=e.urlChild,o=void 0===c?"":c,s=document.createElement("li");s.className="nav-sidebar__item position-relative flex justify-between items-center flex-wrap";var l=document.createElement("a");l.className="nav-sidebar__link block p-15 pl-25 text-md text-white",l.style="padding-left: 40px;",l.href=o||i||"/",l.innerHTML=a||d,s.append(l),_.append(s)})}document.querySelector(".nav-sidebar__list").append(m)})})});'.replace(
    '["<<sections>>"]',
