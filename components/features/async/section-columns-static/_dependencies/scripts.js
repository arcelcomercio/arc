  ...
  requestIdle(() => {
    ...
    const loadFeature = () => {
      ...
      sections.forEach((section, ind) => {
        ...
        const fetchQuery = `{"includedFields":"websites.${arcSite},taxonomy.sections._id,taxonomy.sections.name,${fetchQueryPromoItems},${includedJwPlayerPromoItems},headlines.basic,credits.by._id,credits.by.name,credits.by.url,credits.by.type","presets":"mobile:314x157","section":"/${section}","stories_qty":4}`;
        fetch(
...
export const sectionBlockAsyncScrip = (
  ...
  `"use strict";var _slicedToArray=function(){return function(e,t){if(Array.isArray(e))return e;if(Symbol.iterator in Object(e))return function(e,t){var i=[],o=!0,r=!1,a=void 0;try{for(var c,n=e[Symbol.iterator]();!(o=(c=n.next()).done)&&(i.push(c.value),!t||i.length!==t);o=!0);}catch(e){r=!0,a=e}finally{try{!o&&n.return&&n.return()}finally{if(r)throw a}}return i}(e,t);throw new TypeError("Invalid attempt to destructure non-iterable instance")}}();document.addEventListener("DOMContentLoaded",function(){requestIdle(function(){var e=sectionsToReplace,t=adsHtmlToReplace,i=contextPathToReplace,o=arcSiteToReplace,r=deploymentToReplace,a=function(){return function(){if(!i)return"/pf";if(!o)return i;var e=o+".pe";return"depor"===o&&(e=o+".com"),"elcomerciomag"===o&&(e="elcomercio.pe"),"peru21g21"===o&&(e="peru21.pe"),"https://cdna."+e}()+"/resources/dist/"+o+"/images/default-md.png?d=2"},c=function(e){var t="";switch(e){case"basic_video":t="icon-video";break;case"basic_gallery":t="icon-img";break;default:return""}return t},n=function(e){var t=e.basicVideoUrl,i=e.basicJwPlayerVideoUrl,o=e.basicGalleryUrl;return t||i?"basic_video":o?"basic_gallery":"basic"},s=function(){var i=document.getElementById("section-columns-lazy");e.forEach(function(e,s){var l=document.createElement("div");i.append(l);var d;if(fetch("/pf/api/v3/content/fetch/story-feed-by-section?query="+encodeURI('{"includedFields":"websites.'+o+',taxonomy.sections._id,taxonomy.sections.name,promo_items.basic.type,promo_items.basic.url,promo_items.basic.resized_urls,promo_items.basic_video.promo_items.basic.url,promo_items.basic_video.promo_items.basic.resized_urls,promo_items.basic_gallery.promo_items.basic.type,promo_items.basic_gallery.promo_items.basic.url,promo_items.basic_gallery.promo_items.basic.resized_urls,promo_items.youtube_id.content,promo_items.basic_jwplayer.embed.config.thumbnail_url,promo_items.basic_jwplayer.embed.config.resized_urls,headlines.basic,credits.by._id,credits.by.name,credits.by.url,credits.by.type","presets":"mobile:314x157","section":"/'+e+'","stories_qty":4}')+"&d="+r+"&_website="+o).then(function(e){return e.json()}).then(function(t){var i=function(e){var t=e.section,i=t?"/"+t:"",r=e.content||{},c=r.content_elements,s=void 0===c?[]:c,l=r.section_name,d=_slicedToArray(s||[],1)[0],m=(d=void 0===d?{}:d).websites,u=((void 0===m?{}:m)[o]||{}).website_section,b=(u=void 0===u?{}:u).path,p=void 0===b?"":b,v=u.name;return{sN:l||(void 0===v?"":v)||"",sU:(i||p||"")+"/",cE:s.map(function(e,t){var i=e.headlines,r=(i=void 0===i?{}:i).basic,c=e.websites,s=(c=void 0===c?{}:c)[o],l=(s=void 0===s?{}:s).website_url,d=e.credits,m=(d=void 0===d?{}:d).by,u=_slicedToArray(m=void 0===m?[]:m,1)[0],b=(u=void 0===u?{}:u).name,p=u.url,v=e.promo_items,_=(v=void 0===v?{}:v).basic,f=(_=void 0===_?{}:_).resized_urls,h=(f=void 0===f?{}:f).mobile,y=v.basic_video,g=(y=void 0===y?{}:y).promo_items,w=(g=void 0===g?{}:g).basic,x=(w=void 0===w?{}:w).resized_urls,E=(x=void 0===x?{}:x).mobile,I=v.basic_gallery,T=(I=void 0===I?{}:I).promo_items,L=(T=void 0===T?{}:T).basic,j=(L=void 0===L?{}:L).resized_urls,U=(j=void 0===j?{}:j).mobile,z=v.basic_jwplayer,A=(z=void 0===z?{}:z).embed,B=(A=void 0===A?{}:A).config,S=(B=void 0===B?{}:B).resized_urls,k=(S=void 0===S?{}:S).mobile,V={t:r,u:l,n:b,a:p,m:n({basicVideoUrl:E,basicJwPlayerVideoUrl:k,basicGalleryUrl:U})};return 0===t&&(V.i=k||E||U||h||a()),V})}}({section:e,content:t})||{},r=i.sN,s=i.sU,d=i.cE;l.innerHTML='<div class="sec-col bg-white flex flex-col"> <div class="sec-col__header bg-info flex items-center w-auto pr-20 pl-20 mb-5"><a href="'+s+'" class="flex items-center full-height"><h4 class="sec-col__title uppercase font-bold">'+r+'</h4></a></div> <div role="list" class="sec-col__list bg-white h-full">'+d.map(function(e,t){var i=e.t,o=e.u,r=e.n,a=e.a,n=e.i,s=e.m;return(0===t?'<a href="'+o+'" class="position-relative mb-10 overflow-hidden block">'+(c(s)?'<i class="'+c(s)+' sec-col__icon m-icon position-absolute text-center mx-auto rounded text-gray-100"></i>':"")+'<img class="sec-col__image w-full object-center object-cover" src="'+n+'" alt="'+i+'"/></a>':"")+'<article role="listitem" class="sec-col__story flex flex-col pb-10 mr-20 ml-20 mb-20 text-gray-300 border-b-1 border-dashed border-gray"><a href="'+o+'"><h3 class="sec-col__link mb-15 text-gray-300 line-h-sm font-bold overflow-hidden">'+i+'</h3></a><a class="sec-col__author text-gray-200" href="'+(a||"/autores/")+'">'+(r||"")+"</a></article>"}).join("")+"</div></div>"}).catch(function(e){throw new Error(e)}),4===s){var m=document.createElement("div");m.innerHTML=t||"",i.append(m)}5===s&&(d=document.createElement("div"),i.append(d),fetch("/pf/api/v3/content/fetch/cinema-billboard?query=%7B%22format%22%3A%22single%22%7D&d="+r+"&_website="+o).then(function(e){return e.json()}).then(function(e){var t,i,o,r,c,n,s,l,m,u,b;d.innerHTML=(i=(t=e).billboardData,o=(i=void 0===i?{}:i).moviesList,r=void 0===o?[]:o,c=i.cinemasList,n=void 0===c?[]:c,s=t.premiereData,l=(s=void 0===s?{}:s).alt,m=s.img,u=s.title,'<div class="cinema-card bg-white"> <article class="position-relative"> <h3 class="cinema-card__category uppercase primary-font mb-0 pb-15 text-xl line-h-none"> <a class="cinema-card__link text-gray-300" href="/cartelera"> Cartelera </a> </h3> <figure class="cinema-card__figure overflow-hidden"> <a href="/cartelera/'+(b=s.url)+'/"> <img src="'+(m||a())+'" alt="'+l+'" class="w-full h-full object-cover" /> </a> </figure> <div class="cinema-card__detail w-full position-absolute bottom-0 pt-15 pb-15 pl-20 pr-20"> <p class="cinema-card__premiere text-xl line-h-xs font-bold"> Estreno </p> <h2 class="cinema-card__p-title overflow-hidden title-xs text-white"> <a class="cinema-card__p-link font-bold text-white line-h-xs" href="/cartelera/'+b+'/"> '+u+' </a> </h2> </div> </article> <div class="cinema-card__movies-list p-10"> <h4 class="cinema-card__title uppercase primary-font font-bold pt-5 pb-15 pl-10 pr-10 text-md line-h-none"> Vamos al cine </h4> <form id="cinema-form" action="/cartelera/search" method="post" class="text-right mb-10"> <label htmlFor="movie-select" class="font-0"> PELICULAS </label> <select id="movie-select" name="movie" class="cinema-card__select w-full primary-font mb-10 pl-10 text-xs" value=""> <option value="" defaultValue disabled class="cinema-card__option bg-white"> PELÍCULAS </option> '+r.map(function(e){return'<option value="'+e.url+'" class="cinema-card__option bg-white"> '+e.title+" </option>"}).join("")+' </select> <label htmlFor="theater-select" class="font-0"> CINES </label> <select id="theater-select" name="theater" class="cinema-card__select w-full primary-font mb-10 pl-10 text-xs" value=""> <option value="" defaultValue disabled class="cinema-card__option bg-white"> CINES </option> '+n.map(function(e){return'<option value="'+e.url+'" class="cinema-card__option bg-white"> '+e.nombre+" </option>"})+' </select> <button type="submit" class="cinema-card__button bg-white inline-block uppercase font-bold primary-font border-0 text-md rounded-sm"> Buscar </button> </form> </div></div>'),setTimeout(function(){var e=document.getElementById("cinema-form");document.getElementById("movie-select").value="",document.getElementById("theater-select").value="",e.addEventListener("submit",function(e){var t=document.getElementById("movie-select").value,i=document.getElementById("theater-select").value,o=t||i?(t||"peliculas")+"/"+(i||"cines"):"";window.location.href="/cartelera/"+o+"/",e.preventDefault()})},0)}).catch(function(e){throw new Error(e)}))})};if("IntersectionObserver"in window){new(0,window.IntersectionObserver)(function(e,t){e.forEach(function(e){e.isIntersecting&&(s(),t.unobserve(e.target))})},{rootMargin:"0px 0px 500px 0px"}).observe(document.querySelector("#section-columns-lazy"))}else s()})});`
    .replace(
      'sectionsToReplace',
