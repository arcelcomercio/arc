...
export const sectionBlockAsyncScrip = (
  ...
  `"use strict";function _slicedToArray(e,t){return _arrayWithHoles(e)||_iterableToArrayLimit(e,t)||_nonIterableRest()}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}function _iterableToArrayLimit(e,t){if(Symbol.iterator in Object(e)||"[object Arguments]"===Object.prototype.toString.call(e)){var o=[],i=!0,c=!1,a=void 0;try{for(var n,r=e[Symbol.iterator]();!(i=(n=r.next()).done)&&(o.push(n.value),!t||o.length!==t);i=!0);}catch(e){c=!0,a=e}finally{try{i||null==r.return||r.return()}finally{if(c)throw a}}return o}}function _arrayWithHoles(e){if(Array.isArray(e))return e}document.addEventListener("DOMContentLoaded",function(){var e=sectionsToReplace,t=adsHtmlToReplace,o=contextPathToReplace,i=arcSiteToReplace,c=deploymentToReplace,a=function(e){var t=e.size,c=void 0===t?"lg":t;return"lg"!==c&&"md"!==c&&"sm"!==c?"":"".concat(function(){if(!o)return"/pf";if(!i)return o;var e="".concat(i,".pe");return"depor"===i&&(e="".concat(i,".com")),"elcomerciomag"===i&&(e="elcomercio.pe"),"peru21g21"===i&&(e="peru21.pe"),"https://cdna.".concat(e)}(),"/resources/dist/").concat(i,"/images/default-").concat(c,".png?d=1")},n=function(e){var t="";switch(e){case"basic_video":t="icon-video";break;case"basic_gallery":t="icon-img";break;default:return""}return t},r=function(e){var t=e.basicVideoUrl,o=e.basicGalleryUrl;return t?"basic_video":o?"basic_gallery":"basic"},s=function(){var o=document.getElementById("section-columns-lazy");e.forEach(function(e,s){var l=document.createElement("div");if(o.append(l),fetch("/pf/api/v3/content/fetch/story-feed-by-section?query=%7B%22includedFields%22%3A%22websites.".concat(i,".website_url%2Cpromo_items.basic.type%2Cpromo_items.basic.url%2Cpromo_items.basic.resized_urls%2Cpromo_items.basic_video.promo_items.basic.url%2Cpromo_items.basic_video.promo_items.basic.resized_urls%2Cpromo_items.basic_gallery.promo_items.basic.url%2Cpromo_items.basic_gallery.promo_items.basic.resized_urls%2Cpromo_items.youtube_id.content%2Cheadlines.basic%2Ccredits.by._id%2C%20credits.by.name%2Ccredits.by.url%2Ccredits.by.type%2Ctaxonomy.sections._id%2Ctaxonomy.sections.name%22%2C%22presets%22%3A%22mobile%3A314x157%22%2C%22section%22%3A%22%2F").concat(e,"%22%2C%22stories_qty%22%3A4%7D&filter=%7Bcontent_elements%7Bcredits%7Bby%7Bname%2Curl%7D%7D%2Cheadlines%7Bbasic%7D%2Cpromo_items%7Bbasic%7Bresized_urls%7Bmobile%7D%7D%2Cbasic_gallery%7Bpromo_items%7Bbasic%7Bresized_urls%7Bmobile%7D%7D%7D%7D%2Cbasic_video%7Bpromo_items%7Bbasic%7Bresized_urls%7Bmobile%7D%7D%7D%7D%2Cyoutube_id%7Bcontent%7D%7D%2Ctaxonomy%7Bprimary_section%7Bname%2Cpath%7D%7D%2Cwebsites%7B").concat(i,"%7Bwebsite_url%7D%7D%7D%2Csection_id%2Csection_name%7D&d=").concat(c,"&_website=").concat(i)).then(function(e){return e.json()}).then(function(t){var o=function(e){var t=e.section,o=e.content,c=t?"/".concat(t):"",n=o||{},s=n.content_elements,l=void 0===s?[]:s,d=n.section_name,m=_slicedToArray(l||[],1)[0],u=(m=void 0===m?{}:m).taxonomy,b=(u=void 0===u?{}:u).primary_section,p=(b=void 0===b?{}:b).path,_=b.name;return{sN:d||_||"",sU:"".concat(c||p||"","/"),cE:l.map(function(e,t){var o=e.headlines,c=(o=void 0===o?{}:o).basic,n=e.websites,s=(n=void 0===n?{}:n)[i],l=(s=void 0===s?{}:s).website_url,d=e.credits,m=(d=void 0===d?{}:d).by,u=_slicedToArray(m=void 0===m?[]:m,1)[0],b=(u=void 0===u?{}:u).name,p=u.url,_=e.promo_items,v=(_=void 0===_?{}:_).basic,f=(v=void 0===v?{}:v).resized_urls,h=(f=void 0===f?{}:f).mobile,y=_.basic_video,g=(y=void 0===y?{}:y).promo_items,w=(g=void 0===g?{}:g).basic,x=(w=void 0===w?{}:w).resized_urls,C=(x=void 0===x?{}:x).mobile,B=_.basic_gallery,D=(B=void 0===B?{}:B).promo_items,E=(D=void 0===D?{}:D).basic,A=(E=void 0===E?{}:E).resized_urls,I=(A=void 0===A?{}:A).mobile;return{t:c,u:l,n:b,a:p,...0===t?{i:C||I||h||a({size:"md"})}:{},m:r({basicVideoUrl:C,basicGalleryUrl:I})}})}}({section:e,content:t})||{},c=o.sN,s=o.sU,d=o.cE;l.innerHTML='<div class="sec-col bg-white flex flex-col"> <div class="sec-col__header bg-info flex items-center w-auto pr-20 pl-20 mb-5"><a href="'.concat(s,'" class="flex items-center full-height"><h4 class="sec-col__title uppercase font-bold">').concat(c,'</h4></a></div> <div role="list" class="sec-col__list bg-white h-full">').concat(d.map(function(e,t){var o=e.t,i=e.u,c=e.n,a=e.a,r=e.i,s=e.m;return"".concat(0===t?'<a href="'.concat(i,'" class="position-relative mb-10 overflow-hidden block">').concat(n(s)?'<i class="'.concat(n(s),' sec-col__icon m-icon position-absolute text-center mx-auto rounded text-gray-100"></i>'):"",'<img class="sec-col__image w-full object-center object-cover" src="').concat(r,'" alt="').concat(o,'"/></a>'):"",'<article role="listitem" class="sec-col__story flex flex-col pb-10 mr-20 ml-20 mb-20 text-gray-300 border-b-1 border-dashed border-gray"><a href="').concat(i,'"><h3 class="sec-col__link mb-15 text-gray-300 line-h-sm font-bold overflow-hidden">').concat(o,'</h3></a><a class="sec-col__author text-gray-200" href="').concat(a,'">').concat(c,"</a></article>")}).join(""),"</div></div>")}).catch(function(e){throw new Error(e)}),4===s){var d=document.createElement("div");d.innerHTML=t||"",o.append(d)}if(5===s){var m=document.createElement("div");o.append(m),fetch("/pf/api/v3/content/fetch/cinema-billboard?query=%7B%22format%22%3A%22single%22%7D&d=".concat(c,"&_website=").concat(i)).then(function(e){return e.json()}).then(function(e){var t,o,i,c,n,r,s,l,d,u,b,p;m.innerHTML=(o=(t=e).billboardData,i=(o=void 0===o?{}:o).moviesList,c=void 0===i?[]:i,n=o.cinemasList,r=void 0===n?[]:n,s=t.premiereData,l=(s=void 0===s?{}:s).alt,d=s.img,u=s.title,b=s.url,p=d||a({size:"sm"}),'<div class="cinema-card bg-white"> <article class="position-relative"> <h3 class="cinema-card__category uppercase primary-font mb-0 pb-15 text-xl line-h-none"> <a class="cinema-card__link text-gray-300" href="/cartelera"> Cartelera </a> </h3> <figure class="cinema-card__figure overflow-hidden"> <a href="/cartelera/'.concat(b,'/"> <img src="').concat(p,'" alt="').concat(l,'" class="w-full h-full object-cover" /> </a> </figure> <div class="cinema-card__detail w-full position-absolute bottom-0 pt-15 pb-15 pl-20 pr-20"> <p class="cinema-card__premiere text-xl line-h-xs font-bold"> Estreno </p> <h2 class="cinema-card__p-title overflow-hidden title-xs text-white"> <a class="cinema-card__p-link font-bold text-white line-h-xs" href="/cartelera/').concat(b,'/"> ').concat(u,' </a> </h2> </div> </article> <div class="cinema-card__movies-list p-10"> <h4 class="cinema-card__title uppercase primary-font font-bold pt-5 pb-15 pl-10 pr-10 text-md line-h-none"> Vamos al cine </h4> <form id="cinema-form" action="/cartelera/search" method="post" class="text-right mb-10"> <label htmlFor="movie-select" class="font-0"> PELICULAS </label> <select id="movie-select" name="movie" class="cinema-card__select w-full primary-font mb-10 pl-10 text-xs" value=""> <option value="" defaultValue disabled class="cinema-card__option bg-white"> PELÍCULAS </option> ').concat(c.map(function(e){return'<option value="'.concat(e.url,'" class="cinema-card__option bg-white"> ').concat(e.title," </option>")}).join(""),' </select> <label htmlFor="theater-select" class="font-0"> CINES </label> <select id="theater-select" name="theater" class="cinema-card__select w-full primary-font mb-10 pl-10 text-xs" value=""> <option value="" defaultValue disabled class="cinema-card__option bg-white"> CINES </option> ').concat(r.map(function(e){return'<option value="'.concat(e.url,'" class="cinema-card__option bg-white"> ').concat(e.nombre," </option>")}),' </select> <button type="submit" class="cinema-card__button bg-white inline-block uppercase font-bold primary-font border-0 text-md rounded-sm"> Buscar </button> </form> </div></div>')),setTimeout(function(){var e=document.getElementById("cinema-form");document.getElementById("movie-select").value="",document.getElementById("theater-select").value="",e.addEventListener("submit",function(e){var t=document.getElementById("movie-select").value,o=document.getElementById("theater-select").value,i=o||"cines",c=t||o?"".concat(t||"peliculas","/").concat(i):"";window.location.href="".concat("/cartelera","/").concat(c,"/"),e.preventDefault()})},0)}).catch(function(e){throw new Error(e)})}})};if("IntersectionObserver"in window){new(0,window.IntersectionObserver)(function(e,t){e.forEach(function(e){e.isIntersecting&&(s(),t.unobserve(e.target))})},{rootMargin:"0px 0px 500px 0px"}).observe(document.querySelector("#section-columns-lazy"))}else s()});`
    .replace(
      'sectionsToReplace',
