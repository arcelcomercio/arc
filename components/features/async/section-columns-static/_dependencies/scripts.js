  ...
  requestIdle(() => {
    ...
    const loadFeature = () => {
      ...
      sections.forEach((section, ind) => {
        ...
        fetch(  
          `/pf/api/v3/content/fetch/story-feed-by-section?query=%7B%22includedFields%22%3A%22websites.${arcSite}%2Ctaxonomy.sections._id%2Ctaxonomy.sections.name%2Cpromo_items.basic.type%2Cpromo_items.basic.url%2Cpromo_items.basic.resized_urls%2Cpromo_items.basic_video.promo_items.basic.url%2Cpromo_items.basic_video.promo_items.basic.resized_urls%2Cpromo_items.basic_gallery.promo_items.basic.url%2Cpromo_items.basic_gallery.promo_items.basic.resized_urls%2Cpromo_items.youtube_id.content%2Cheadlines.basic%2Ccredits.by._id%2C%20credits.by.name%2Ccredits.by.url%2Ccredits.by.type%22%2C%22presets%22%3A%22mobile%3A314x157%22%2C%22section%22%3A%22%2F${section}%22%2C%22stories_qty%22%3A4%7D&d=${deployment}&_website=${arcSite}`
        )
          .then(res => res.json())
          .then(content => {
