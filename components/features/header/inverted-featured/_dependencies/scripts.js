...
export const singwallScript =
  '"use strict";document.addEventListener("DOMContentLoaded",function(){requestIdle(function(){var n=JSON.parse(window.localStorage.getItem("ArcId.USER_PROFILE"));console.log(n);var e=n||{},t=e.firstName,a=void 0===t?"":t,c=e.lastName,o=void 0===c?"":c,i=e.uuid,l=void 0===i?"":i;if(document.getElementById("signwall-nav-btn").addEventListener("click",function(){window.location.href=l?"/mi-perfil/?outputType=signwall":"/signwall/?outputType=signwall"}),l){var d=document.getElementById("signwall-nav-btn"),s=document.getElementById("signwall-nav-icon");if(a||o){var r="",u="";a&&o?(r="".concat(a," ").concat(o),u="".concat(a[0]||"").concat(o[0]||"")):a&&!o?(r=a,u="".concat(a[0]||"").concat(a[1]||"")):!a&&o&&(r=o,u="".concat(o[0]||"").concat(o[1]||"")),d.innerHTML=r.length>=15?"".concat(r.slice(0,15),"..."):r,s.innerHTML=u,s.className="uppercase"}else d.innerHTML="Bienvenido Usuario"}})});'
