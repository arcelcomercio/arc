...
export const InvertedStickyScript =
  'document.addEventListener("DOMContentLoaded",()=>{requestIdle(()=>{const e=document.getElementById("h-basic-pointer"),t=document.getElementById("header-inverted-featured"),n=document.getElementById("header-inverted-featured__logo");function s(){t.classList.add("active"),n.classList.add("active")}function c(){t.classList.remove("active"),n.classList.remove("active")}if("IntersectionObserver"in window){new IntersectionObserver(function(e){e.forEach(e=>{e.isIntersecting?c():s()})}).observe(e)}else window.addEventListener("scroll",()=>{const{body:t={},documentElement:n={}}=document,{scrollTop:d=0}=t,{scrollTop:o=0}=n,i=d||o;i>60&&!e.className.includes("active")?s():i<=60&&e.className.includes("active")&&c()})})});'
