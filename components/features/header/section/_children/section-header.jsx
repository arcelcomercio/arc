...
const classes = {
  ...
  menuSearchInput: `section-menu__search-input bg-transparent border-white w-full font-bold pr-40 pl-10 border-1 border-solid text-md`,
  menuSearchIcon: 'icon-search ',
  menuButtonSearchIcon: `section-menu__search-icon position-absolute text-md`,
