...
import { SITE_GESTION, SITE_TROME } from '../../../utilities/constants/sitenames'
...
const HeaderContinuous = (props) => {
  ...
  const getMainImage = () => {
    if (isSomos) return 'https://cloudfront-us-east-1.images.arcpublishing.com/elcomercio/HJJOUB5ZYJDCZLCVEKSSBBWXPE.png'
