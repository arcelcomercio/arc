...
const StoryContinueUrlLite: FC<FeatLiteProps> = (props) => {
  ...
  return (
    <>
      <div className="st-continue__progress-box flex position-relative">
        <div className="st-continue__progress" />
        <span className="st-continue__subtitle position-absolute">
          CARGANDO SIGUIENTE...
        </span>
        <svg
          role="button"
