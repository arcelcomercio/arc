...
const StoryContinueLite = props => {
  ...
  const filterStoriesCb = (story = {}) => {
    ...
    return (
      !/^\/(somos|archivo-elcomercio)\//.test(requestUri) &&
