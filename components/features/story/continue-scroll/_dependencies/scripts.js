  ...
  const loadNextUrlStorage = (observedElement) => {
    ...
    if(nextStory.link){
      ...
      requestIdle(() => {
        ...
        let nextUrl = location.origin + "/carga-continua" + nextStory.link + "?ref=nota&ft=cargacontinua" + noTaboola + "&outputType=lite&story=" + storyCounter
        nextUrl = context()
