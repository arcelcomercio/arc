...
const classes = {
  ...
  titleAmp: 'story-header-amp__title font-bold primary-font title-md',
  datetime:
    'story-header-amp__datetime mt-15 mb-15 block secondary-font text-lg',
  description: 'story-header-amp__description mt-0 text-md',
