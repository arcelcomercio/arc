/* requestIdle(() => {
  const getAssetsPath = (arcSite, contextPath) => {
    ...
    if (arcSite === 'elcomerciomag' || arcSite === 'perucom') site = 'elcomercio.pe'
