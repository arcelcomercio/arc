...
window.addEventListener('load', () => {requestIdle(() => {
  ...
  window.addEventListener( "message", function (e) {  if(e.data === 'MessageContinue') alert("Alerta antes de la url signwall"); }, false);
...
const StoryContinueLite = props => {
  ...
  //   storiesByTag: [{link:'/mundo/actualidad/terremoto-en-turquia-ayda-gezgin-una-nina-de-tres-anos-rescatada-con-vida-91-horas-despues-del-sismo-en-esmirna-noticia/',title:'terremoto'},{link:'',title:''}],
  ...
  const stContinueScript = `"use strict";window.addEventListener("load",function(){requestIdle(function(){var e="<<recentStoriesrecentStoriesrecentStories>>",t=JSON.parse(window.sessionStorage.getItem("_recent_articles_"))||{},n=document.getElementById("st-continue-0"),i=function(t){void 0===t&&(t={});var n=t,i=n.section;n.data;window.sessionStorage.setItem("_recent_articles_",JSON.stringify({section:i,data:e.data}))};window.addEventListener("message",function(e){"MessageContinue"===e.data&&alert("Alerta antes de la url signwall")},!1),t.section?(window.sessionStorage.removeItem("_recent_articles_"),i(e)):i(e);var o=0,r=1,s=0,a=(JSON.parse(window.sessionStorage.getItem("_recent_articles_"))||{}).data||{storiesByTag:[],storiesBySection:[],storiesBySectionPremium:[]},c=function(){var e=!1;if(window.localStorage&&window.localStorage.hasOwnProperty("ArcId.USER_INFO")&&"{}"!==window.localStorage.getItem("ArcId.USER_INFO")){var t=JSON.parse(window.localStorage.getItem("ArcId.USER_INFO")).uuid,n=JSON.parse(window.localStorage.getItem("ArcP")||"{}")[t];n&&n.sub.p.length&&(e=!0)}else e=!1;return e}()?[].concat(a.storiesBySectionPremium,a.storiesByTag):[].concat(a.storiesByTag,a.storiesBySection);c.unshift({title:document.title,link:location.pathname});var d=function(){return location.href.includes("/pf")},l=function(e){void 0===e&&(e=0),requestIdle(function(){if("IntersectionObserver"in window){var t=null;e<=0?(t=document.getElementById("contenedor")).setAttribute("data-index",0):e>0&&(t=document.getElementById("st-iframe-"+e));var n=new IntersectionObserver(function(e){e.forEach(function(e){if(e.isIntersecting){var t=parseInt(e.target.dataset.index);o===t?r=e.intersectionRatio:r<.02&&e.intersectionRatio>.02&&(o=t,r=e.intersectionRatio,n=c[o],i=o,document.title=n.title,history.pushState({story:i},n.title,d()?"/pf"+n.link:n.link))}var n,i})},{rootMargin:"0px",threshold:function(){for(var e=[],t=1;t<=50;t++){var n=t/50;e.push(n)}return e.push(0),e}()});t&&n.observe(t)}})},u=(/iPad|iPhone|iPod|android|webOS|Windows Phone/i.test("undefined"!=typeof window?window.navigator.userAgent:""),function(e){var t=c[s+=1]||{};t.link&&(requestIdle(function(){var n=t.link+"?ref=nota&ft=autoload&story="+s;n=d()?n+"&outputType=lite&_website=<<arcSite>>":n;var i=document.createElement("iframe");i.src=location.origin+n,i.width="100%",i.height="6000",i.id="st-iframe-"+s,i.frameborder="0",i.scrolling="no",i.setAttribute("data-index",s),e.insertAdjacentElement("afterEnd",i),l(s)}),requestIdle(function(){var e=document.createElement("div");e.id="st-continue-"+s,e.style.height="10px";var t=document.getElementById("st-iframe-"+s);t.insertAdjacentElement("afterEnd",e),f(e),t.onload=function(){requestIdle(function(){t.height=t.contentWindow.document.documentElement.offsetHeight+"px"})}}))}),f=function(e){if("IntersectionObserver"in window){var t=new IntersectionObserver(function(e){e.forEach(function(e){e.isIntersecting&&(u(e.target),t.unobserve(e.target))})},{rootMargin:"0px 0px 800px 0px"});t.observe(e)}else window.addEventListener("scroll",function(){!function e(t){window.innerHeight+document.documentElement.scrollTop>=t.offsetTop-800&&window.removeEventListener("scroll",function(){e(t)}),u(t)}(e)})};f(n),l(0)})});`
