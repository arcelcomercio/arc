...
//   const backupAttributes = Array.isArray(attributes)
//     ? attributes.filter(({ name }) => !GET_ATTRIBUTES_PROFILE.includes(name))
//     : []

//   console.log(publicProfile)
//   console.log(backupAttributes)
...
//         if (value.length === 0) {
//           formErrors.fecha = ''
//         } else if (fechaRegex.test(value)) {
//           formErrors.fecha = ''
//         } else {
//           formErrors.fecha = 'Fecha inválida'
//         }
//         break
//       default:
//     }
...
//                 onChange={(e) => {
//                   this.handleValidation(e)
//                   this.guardarFecha(e.target.value)
//                 }}
//                 className={
//                   formErrors.fecha.length > 0 ? 'input error' : 'input'
//                 }
//               />
...
//               </label>
//             </div>
//             {/* <Fecha guardarFecha={this.guardarFecha} /> */}
//             <div className="sign-profile_update-form-group">
//               <input
//                 type="text"
//                 inputMode="email"
