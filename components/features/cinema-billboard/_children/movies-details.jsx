...
const classes = {
  ...
  where: 'movie-details__where uppercase mb-15 text-sm text-white',
  hours:
    'movie-details__hours scroll-vertical-auto h-auto pr-30 border-r-1 border-solid',
  item: 'mb-20',
  cinema: 'movie-details__cinema block font-bold text-sm text-white',
  ...
  name: 'movie-details__name font-bold mb-15 text-sm text-white',
