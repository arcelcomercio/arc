...
const classes = {
  ...
  label:
    'movies-filter__label md:pt-0 md:pb-0 md:pr-10 md:pl-10 md:inline-block uppercase font-bold hidden line-h-none text-sm lg:pt-0 lg:pb-0 lg:pr-10 lg:pl-10',
  form:
