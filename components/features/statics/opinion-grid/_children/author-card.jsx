...
const classes = {
  ...
  wrapper: 'author-card__wrapper md:flex-row-reverse flex position-relative',
  imageBox:
    'author-card__box-image md:p-0 md:right-0 md:bottom-0 flex items-start position-relative pt-15 pb-15 pr-10 pl-10',
  image: 'author-card__image md:w-full md:h-full bg-white object-cover object-top rounded',
