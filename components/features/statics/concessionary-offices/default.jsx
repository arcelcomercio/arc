...
const classes = {
  ...
  locations: `concessionaires__locations border-gray-100 pt-25 border-t-1 border-solid`,
  search: 'concessionaires__search flex mb-20 flex-col',
  searchTitle: `concessionaires__search-title text-gray-300 uppercase font-bold text-center pt-15 pr-20 pl-20 text-sm md:mb-20`,
  form: 'flex',
  ...
  district: 'concessionaires__controls flex md:flex-row',
