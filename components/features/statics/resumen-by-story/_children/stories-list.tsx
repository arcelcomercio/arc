...
import { EmbedConfigDataStories } from 'types/story'
 ...
 */
const StaticsResumen2020StoriesList: React.FC<{
  mainPath: string
  nextSectionPath: string
  list?: EmbedConfigDataStories[]
}> = (props) => {
  const { mainPath, nextSectionPath, list } = props
    ...
    <main className="st-list">
      ...
      {!nextSectionPath && (
        <div className="st-list__footer">
          ...
          <div className="st-list__footer-line" />
