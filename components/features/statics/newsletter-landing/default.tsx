...
const NewsletterLanding: FC<FeatureProps> = (props) => {
  ...
  window.addEventListener('DOMContentLoaded', () => {requestIdle(() => {
    ...
    form.addEventListener("submit", e => {
      ...
      if(validEmail && formInputs[1].checked) {
