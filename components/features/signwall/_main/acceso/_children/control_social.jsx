...
export const ButtonStyleSocial = styled(Button)`
  ...
  & svg {
    position: absolute;
    left: ${props => (props.brand === 'facebook' ? '10px' : '0px')};
    top: ${props => (props.brand === 'facebook' ? '10px' : '0px')};
  }
  height: 48px;
  display: inline-block;
  vertical-align: top;
  padding: 0px 10px 0px 45px;
  background: ${props => (props.brand === 'facebook' ? '#4267b2' : '#4285f4')};
  border: 1px solid
    ${props => (props.brand === 'facebook' ? '#4267b2' : '#4285f4')};
  margin-right: ${props =>
    props.size === 'middle' && props.brand === 'facebook' ? '10px' : '0px'};
  margin-left: ${props =>
    props.size === 'middle' && props.brand === 'google' ? '10px' : '0px'};
  width: calc(
