...
const classes = {
  ...
  menuContainer: 'premios_depor__header__cont__menuContainer',

  menu: 'premios_depor__header__cont__menuContainer__menu',
  menuClosed: 'premios_depor__header__cont__menuContainer__menuClosed',
  button: 'premios_depor__header__cont__menuContainer__button',
  menuBlack: 'premios_depor__header__cont__menuContainer__menuBlack',
  menuOpen: 'premios_depor__header__cont__menuContainer__menuClosed',
  tools: 'premios_depor__header__cont__menuContainer__tools',
  // toolsHidden: 'premios_depor__header__menuContainer__toolsHidden',
  toolsVisible: 'premios_depor__header__cont__menuContainer__toolsVisible',
  icon: 'premios_depor__header__cont__menuContainer__icon',
  pen: 'premios_depor__header__cont__menuContainer__pen',

  conLeftClosed: 'premios_depor__header__cont__conLeftClosed',
  buttonMenu: 'premios_depor__header__cont__menuContainer__buttonMenu',

  // lunes
  hamburger: 'premios_depor__header__hamburger',
  burger: 'premios_depor__header__burger',
