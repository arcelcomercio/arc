...
const classes = {
  ...
  loginButton:
    'navbar-somos__login-button font-bold uppercase flex items-center primary-font text-sm',
  iconUser: 'icon-user navbar-somos__icon-user mr-5',
  searchIcon: 'icon-search navbar-somos__icon',
  searchInput: 'navbar-somos__search-input primary-font font-bold text-md',
