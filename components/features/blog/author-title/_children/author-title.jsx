...
const classes = {
  ...
  section:
    'author-title__section md:flex-shrink md:pt-10 md:mt-10 md:font-bold md:flex-grow position-relative flex-grow-0 flex-shrink-0 border-b-1 border-t-1 border-solid line-h-none',
