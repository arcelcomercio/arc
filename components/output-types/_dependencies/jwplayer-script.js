...
const jwplayerObserver = (entries, observer) => {
  entries.forEach(entry => {
    ...
    if (isIntersecting) {
      ...
      var pluginJwplayer = document.getElementById('plugin_jwplayer')
      if(!pluginJwplayer){
        const node = document.createElement('script')
        node.type = 'text/javascript'
        node.id='plugin_jwplayer'
        node.src = 'https://sb.scorecardresearch.com/internal-c2/plugins/streamingtag_plugin_jwplayer.js'
...
const videoScript = `"use strict";const jwplayerObserver=(e,t)=>{e.forEach(e=>{const{isIntersecting:r,target:n}=e;if(r){console.log("target",n);let e=n.getAttribute("id"),r=n.getAttribute("data-playerId");const s=n.getAttribute("data-hasAds");var a=document.getElementById("jwplayerIdScript");if(!document.getElementById("plugin_jwplayer")){const e=document.createElement("script");e.type="text/javascript",e.id="plugin_jwplayer",e.src="https://sb.scorecardresearch.com/internal-c2/plugins/streamingtag_plugin_jwplayer.js",document.head.append(e)}if(a&&a.parentNode.removeChild(a),r){const e="https://cdn.jwplayer.com/libraries/"+r+".js",t=document.createElement("script");t.type="text/javascript",t.id="jwplayerIdScript",t.src=e,document.head.append(t)}var i=document.getElementById("image_"+e);const c=[{file:"https://cdn.jwplayer.com/manifests/"+e+".m3u8",title:i.getAttribute("alt"),recommendations:"https://cdn.jwplayer.com/v2/media/"+e,image:i.getAttribute("src")}];setTimeout(function(){0==s?jwplayer(e).setup({playlist:c,advertising:""}):jwplayer(e).setup({playlist:c}),jwplayer().on("ready",function(){ns_.StreamingAnalytics.JWPlayer(jwplayer(),{publisherId:"8429002"})})},558),t.unobserve(n)}})};window.addEventListener("load",function(){requestIdle(function(){if("IntersectionObserver"in window){var e=Array.from(document.body.querySelectorAll(".jwplayer-lazy")),t=new IntersectionObserver(jwplayerObserver,{rootMargin:"0px"});e.forEach(function(e){t.observe(e)})}})});`
