...
const jwplayerObserver = (entries, observer) => {
  entries.forEach(entry => {
    ...
    if (isIntersecting) {
      ...
      const advertising = hasAds==0? advertising: { schedule: "",  },:''
