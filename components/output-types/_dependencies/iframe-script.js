...
requestIdle(()=> {
  if ('IntersectionObserver' in window) {
    ...
    const iframesc = Array.from(document.body.querySelectorAll('.s-multimedia__lL-iframe'))
    const iframes = Array.from(document.body.querySelectorAll('.story-contents__lL-iframe')).concat(iframesc)
