...
document.addEventListener('DOMContentLoaded', () => {
  window.requestIdle(() => {
    ...
    const checkCookieMigration = () => {
      document.cookie = `ArcId.USER_INFO=;path=/;domain=.${arcSite}.pe; expires=Thu, 01 Jan 1970 00:00:01 GMT`
    }
...
const vallaSignwall = ({ arcEnv, arcSite, getdata }) =>
  ...
  }.${arcSite}.pe"};var l=document.createElement("script");l.src="https://elcomercio-".concat(arcSite,"-").concat(arcEnv,".cdn.arcpublishing.com/arc/subs/p.js?v=").concat(getdata),l.async="true",document.head.appendChild(l)}n()||(document.cookie="ArcId.USER_INFO=;path=/;domain=.".concat(arcSite,".pe; expires=Thu, 01 Jan 1970 00:00:01 GMT"))})});`
