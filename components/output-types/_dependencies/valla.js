        ...
        window.ArcPOptions = {
          paywallFunction: function(campaign) {
            if (campaign.match(/signwallHard/) && !checkSession()) {
              top.postMessage('MessageContinueSignwall__'+getUrlSignwall(), location.origin);
              ...
              getBoottonclick()
              top.postMessage('MessageContinuePaywall__true', location.origin);
            }
          },
