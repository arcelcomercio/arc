        ...
        if (existAds) {
          ...
          const firstRequest = () => {
            ...
            if(adUnitsSet.length > 0) {
              ...
              const gptSlots = adSlots.filter(ad => adUnits[ad.getSlotElementId()])
