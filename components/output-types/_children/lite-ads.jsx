  ...
  /* window.addEventListener('load', function liteAds() {
      requestIdle(function initLiteAds() {
        ...
        if (adsSlots && adsSlots.length > 0) {
          ...
          const adUnits = {
            'gpt_caja1': {
              ...
              "bids":[
                ...
                {
                  "bidder":"ix","labels":["desktop"],
                  "params":{"siteId":"385725"}
                },
                {
            ...
            'gpt_top': {
              ...
              "bids":[
                ...
                {
                  "bidder":"ix","labels":["desktop", "phone"],
                  "params":{"siteId":(isMobile) ? "385731" : "385719"}
                },
                {
                  "bidder":"pubmatic","labels":["desktop"],
            ...
            'gpt_zocalo': {
              ...
              "bids":[
                ...
                {
                  "bidder":"ix","labels":["desktop", "phone"],
                  "params":{"siteId":(isMobile) ? "387393" : "385720"}
                },
                {
                  "bidder":"pubmatic","labels":["desktop", "phone"],
            ...
            'gpt_caja3': {
              ...
              "bids":[
                ...
                {
                  "bidder":"ix","labels":["phone"],
                  "params":{"siteId":"385732"}
                },
                {
          ...
          const loadFirstAds = adsSlots.filter(slot => sl t.getAttribute('data-ads-load-first') === "true") || []
          ...
          requestIdle(function() {
            const loadLazilyAds = adsSlots.filter(slot => sl t.getAttribute('data-ads-load-first') !== "true") || []
