            ...
            <div className="hzhIjB">
              ...
              <div className="gnsiwo">
                <div className="iiXQqj">
                  ...
                  <div className="plan-digital">Plan Digital</div>
                  <center>
                    <img
                      alt="Logo"
              ...
              <div className="content">
                ...
                <button type="button" className="sc-bxivhb planes" id="planes">
                  VER PLANES
                </button>
                <p className="suscrito">¿ESTÁS SUSCRITO AL DIARIO IMPRESO?</p>
                <div className="note-premium">
                  Disfruta<strong> 6 meses GRATIS</strong>
                </div>
                <div className="note-premium">
