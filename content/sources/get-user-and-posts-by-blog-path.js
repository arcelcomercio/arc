...
const resolve = key => {
  const blogPath = key.blog_path || 'divinaejecutiva'
  ...
  const url = `https://dev-svc-blogs.gestion.pe/service/apiblogs.php?json=get_user_and_posts_by_blog_path&blog_path=${blogPath}&posts_limit=${postsLimit}&posts_offset=${postsOffset}&token=${process
